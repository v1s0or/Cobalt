...
public class ServeApplet implements WebService {
    ...
    public ServeApplet(byte[] signed_jar, String win_payload,
                       byte[] java_payload, String title) {
        this.applet_clazz = null;
    ...
    public void setup(WebServer w, String applet_uri, String applet_clazz) {
        ...
        String[] begin = {"applet", "loader", "data", "animation", "chat", "effect", "ticker", "viewer", "toolkit", "gui", "graphics", "support", "supplemental", "optional", "analytics", "live", "user", "profile", "browser", "connection", "crypto", "math", "auxiliary", "aux", "server", "cookie", "libs", "library", "open", "demo", "example", "simple", "game", "manager", "container", "fonts", "images", "content", "native", "canvas", "extra", "session", "web", "tk", "lib", "license", "util", "utils", "choose", "selector", "begin", "office", "documents", "theme", "store", "processor", "merchant", "plugin", "program", "registry", "register", "reputation", "scanner", "source", "enhancements", "macro", "essential", "content", "ml", "markup", "meta", "archive", "report", "info", "help", "helper", "guide", "api", "basic", "interpreter", "scroll", "pipe", "graph", "calculator", "component", "service", "test", "reader", "touch", "gestures", "converter", "list", "advanced", "mobile", "tablet", "os", "cross_platform", "platform", "power", "schedule", "calendar", "secure", "safe", "lock", "key", "cipher", "suite", "highlight", "manual", "automatic", "robot", "require", "internal", "external", "case",
                (alpha.charAt(aa % alpha.length())
                + alpha.charAt(bb % alpha.length())
                + alpha.charAt(cc % alpha.length())
                + alpha.charAt(dd % alpha.length()))
                + "", "digest", "bean", "ui", "system", "win", "tooltip"};

        this.jar_uri = begin[aa % begin.length]
                + alpha.charAt(bb % alpha.length()) + alpha.charAt(cc % alpha.length()) + ".jar";
    ...
    public Response serve(String uri, String method, Properties header, Properties param) {
        if (uri.endsWith(this.jar_uri)) {
            return new Response("200 OK", "application/java-archive",
                    new ByteArrayInputStream(this.signed_jar));
        }
        if (uri.endsWith(this.lib_uri)) {
            return new Response("200 OK", "application/java-archive",
                    new ByteArrayInputStream(this.java_payload));
        }
        return new Response("200 OK", "text/html", resource("/resources/applet.html"));
    }
